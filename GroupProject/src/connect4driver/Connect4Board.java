...
public class Connect4Board extends GameBoard {
    ...
    /**
     * @param numberOfPlayers Passed in parameters is number of players playing
     * the game.
     */
    @Override
    public void gamePieces(int numberOfPlayers, String name1, String name2) {
        switch (numberOfPlayers) {
            ...
            default ->
                System.out.println("Game can only be played with 1 or 2 players, please re-enter the number of players and try again.");
        }
    }

    /**
     * @param column
     * @param player Parameters are the column the player wants the place the
     * piece in and which players turn it is, the main driver should
     * automatically pass this in without any input from user.
     */
    @Override
    ...
    /**
     * @param row
     * @param column removes a piece from a specific location of the board.
     */
    @Override
